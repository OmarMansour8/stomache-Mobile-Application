...
class GroundBeefPasta extends StatefulWidget {
  String Email = '';
  String Password = '';
  String fullName = '';
  String mobileNumber = '';
  ...
  @override
  State<GroundBeefPasta> createState() => _GroundBeefPastaState(
      Email: Email,
      Password: Password,
      fullName: fullName,
...
class _GroundBeefPastaState extends State<GroundBeefPasta> {
  ...
  int quantity = 1;
  double price = 75;
  double smallTacoPrice = 75.00;
  double mediumTacoPrice = 95.00;
