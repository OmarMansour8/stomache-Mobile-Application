...
class SpagettiNoodles extends StatefulWidget {
  String Email = '';
  String Password = '';
  String fullName = '';
  String mobileNumber = '';
  ...
  @override
  State<SpagettiNoodles> createState() => _SpagettiNoodlesState(Email: Email, Password: Password, fullName: fullName, mobileNumber: mobileNumber, gender: gender, dateOfBirth: dateOfBirth, cart: cart, totalAmount: totalAmount, orders: orders);
}

class _SpagettiNoodlesState extends State<SpagettiNoodles> {
  ...
  String dateOfBirth = '';
  List<Widget> cart = [];
  String name ='Spaghetti Noodles';
  String image = "images/pasta1.jpg";
  List<String> orders=[];

  _SpagettiNoodlesState(
      {required this.Email,
        required this.Password,
        required this.fullName,
        required this.mobileNumber,
