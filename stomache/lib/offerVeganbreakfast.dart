...
class offerVeganBreakfast extends StatefulWidget {
  String Email = '';
  String Password = '';
  String fullName = '';
  String mobileNumber = '';
  ...
  @override
  State<offerVeganBreakfast> createState() => _offerVeganBreakfastState(Email: Email, Password: Password, fullName: fullName, mobileNumber: mobileNumber, gender: gender, dateOfBirth: dateOfBirth, cart: cart, totalAmount: totalAmount, orders: orders);
}

class _offerVeganBreakfastState extends State<offerVeganBreakfast> {
  ...
  String dateOfBirth = '';
  List<Widget> cart = [];
  String name ='Fire Burger (offer)';
  String image = "images/image5.jpg";
  double totalAmount = 0;
  List<String> orders=[];

  _offerVeganBreakfastState(
      {required this.Email,
        required this.Password,
        required this.fullName,
        required this.mobileNumber,
