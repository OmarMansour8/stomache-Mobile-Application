...
class SpagettiPastaNoodles extends StatefulWidget {
  String Email = '';
  String Password = '';
  String fullName = '';
  String mobileNumber = '';
  ...
  @override
  State<SpagettiPastaNoodles> createState() => _SpagettiPastaNoodlesState(Email: Email, Password: Password, fullName: fullName, mobileNumber: mobileNumber, gender: gender, dateOfBirth: dateOfBirth, cart: cart);
}

class _SpagettiPastaNoodlesState extends State<SpagettiPastaNoodles> {
