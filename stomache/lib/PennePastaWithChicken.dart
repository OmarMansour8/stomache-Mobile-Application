...
class PennePastaWithChicken extends StatefulWidget {
  String Email = '';
  String Password = '';
  String fullName = '';
  String mobileNumber = '';
  ...
  PennePastaWithChicken(
      {required this.Email,
        ...
        required this.cart});
  @override
  State<PennePastaWithChicken> createState() => _PennePastaWithChickenState(Email: Email, Password: Password, fullName: fullName, mobileNumber: mobileNumber, gender: gender, dateOfBirth: dateOfBirth, cart: cart);
}

class _PennePastaWithChickenState extends State<PennePastaWithChicken> {
