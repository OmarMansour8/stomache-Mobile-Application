...
class CreamyEggs extends StatefulWidget {
  ...
  @override
  State<CreamyEggs> createState() => _CreamyEggsState(Email: Email, Password: Password, fullName: fullName, mobileNumber: mobileNumber, gender: gender, dateOfBirth: dateOfBirth, cart: cart, totalAmount: totalAmount, orders: orders);
}

class _CreamyEggsState extends State<CreamyEggs> {
  bool isFavourite = false;
  IconData x = (Icons.favorite_outline);
  Color y = Colors.black;
  int quantity = 1;
  double price = 0;
  double smallTacoPrice = 30.00;
  double mediumTacoPrice = 45.00;
  double largeTacoPrice = 50.00;
  String selectedSize = '';
  int favourite = 0;
  String Email = '';
  String Password = '';
  ...
  String dateOfBirth = '';
  List<Widget> cart = [];
  String name ='Creamy Eggs';
  String image = "images/breakfast5.png";
  double totalAmount = 0;
  List<String> orders=[];
