...
class CreamyEggs extends StatefulWidget {
  ...
  @override
  State<CreamyEggs> createState() => _CreamyEggsState(Email: Email, Password: Password, fullName: fullName, mobileNumber: mobileNumber, gender: gender, dateOfBirth: dateOfBirth, cart: cart);
}
