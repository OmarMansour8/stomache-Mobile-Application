...
@override
State<offerFruityPanCake> createState() => _offerFruityPanCakeState(Email: Email, Password: Password, fullName: fullName, mobileNumber: mobileNumber, gender: gender, dateOfBirth: dateOfBirth, cart: cart, totalAmount: totalAmount, orders: orders);
}

class _offerFruityPanCakeState extends State<offerFruityPanCake> {
  ...
  String dateOfBirth = '';
  List<Widget> cart = [];
  String name ='Fruity Pancake(offer)';
  String image = "images/breakfast3.png";
  double totalAmount = 0;
  List<String> orders=[];

  _offerFruityPanCakeState(
      {required this.Email,
        required this.Password,
        required this.fullName,
        required this.mobileNumber,
