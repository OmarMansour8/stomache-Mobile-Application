...
class ChickenRanchPizza extends StatefulWidget {
  ...
  @override
  State<ChickenRanchPizza> createState() => _ChickenRanchPizzaState(Email: Email, Password: Password, fullName: fullName, mobileNumber: mobileNumber, gender: gender, dateOfBirth: dateOfBirth, cart: cart, totalAmount: totalAmount, orders: orders);
}

class _ChickenRanchPizzaState extends State<ChickenRanchPizza> {
  ...
  String dateOfBirth = '';
  List<Widget> cart = [];
  String name ='Chicken Ranch';
  String image = "images/pizza3.jpg";
  List<String> orders=[];

  _ChickenRanchPizzaState(
      {required this.Email,
        required this.Password,
        required this.fullName,
        required this.mobileNumber,
