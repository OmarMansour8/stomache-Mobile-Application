...
class offerBuffaloPizza extends StatefulWidget {
  ...
  @override
  State<offerBuffaloPizza> createState() => _offerBuffaloPizzaState(Email: Email, Password: Password, fullName: fullName, mobileNumber: mobileNumber, gender: gender, dateOfBirth: dateOfBirth, cart: cart, totalAmount: totalAmount, orders: orders);
}
