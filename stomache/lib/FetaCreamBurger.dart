...
class BurgerWithCreamFeta extends StatefulWidget {
  String Email = '';
  String Password = '';
  String fullName = '';
  String mobileNumber = '';
  ...
  @override
  State<BurgerWithCreamFeta> createState() => _BurgerWithCreamFetaState(Email: Email, Password: Password, fullName: fullName, mobileNumber: mobileNumber, gender: gender, dateOfBirth: dateOfBirth, cart: cart, totalAmount: totalAmount, orders: orders);
}

class _BurgerWithCreamFetaState extends State<BurgerWithCreamFeta> {
  bool isFavourite = false;
  IconData x = (Icons.favorite_outline);
  Color y = Colors.black;
  int quantity = 1;
  double price = 0;
  double smallTacoPrice = 60.00;
  double mediumTacoPrice = 90.00;
  double largeTacoPrice = 110.00;
  String selectedSize = '';
  int favourite = 0;
  String Email = '';
  String Password = '';
  ...
  String dateOfBirth = '';
  List<Widget> cart = [];
  String name ='Feta Cream Burger';
  String image = "images/burger1.jpg";
  double totalAmount = 0;
  List<String> orders=[];

  _BurgerWithCreamFetaState(
      {required this.Email,
        required this.Password,
        required this.fullName,
        required this.mobileNumber,
