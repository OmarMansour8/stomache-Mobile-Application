...
class BurgerWithCreamFeta extends StatefulWidget {
  ...
  BurgerWithCreamFeta(
      {required this.Email,
        ...
        required this.cart});
  @override
  State<BurgerWithCreamFeta> createState() => _BurgerWithCreamFetaState(Email: Email, Password: Password, fullName: fullName, mobileNumber: mobileNumber, gender: gender, dateOfBirth: dateOfBirth, cart: cart);
}
